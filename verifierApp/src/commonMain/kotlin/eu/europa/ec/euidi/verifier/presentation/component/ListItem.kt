...
import androidx.compose.ui.unit.dp
import eu.europa.ec.euidi.verifier.presentation.component.ClickableArea.ENTIRE_ROW
import eu.europa.ec.euidi.verifier.presentation.component.ClickableArea.TRAILING_CONTENT
...
import eu.europa.ec.euidi.verifier.presentation.component.utils.DEFAULT_ICON_SIZE
import eu.europa.ec.euidi.verifier.presentation.component.utils.ICON_SIZE_40
...
import eu.europa.ec.euidi.verifier.presentation.component.wrap.WrapSwitch
 ...
 * icons and user images (loaded from base64 strings).
 *
...
private fun ListItemPreview() {
    PreviewTheme {
        val leadingIcon = AppIcons.Close
        ...
        Column(
            ...
            ListItem(
                item = ListItemDataUi(
                    ...
                    leadingContentData = ListItemLeadingContentDataUi.Icon(iconData = leadingIcon),
                    trailingContentData = ListItemTrailingContentDataUi.Icon(
                        iconData = AppIcons.ExpandMoreIcon,
                    )
                ),
                modifier = modifier,
                onItemClick = {},
