...
private val leadingIcon = AppIcons.Check
private val trailingIcon = AppIcons.Close
...
// New previews for selected and enabled combinations
@ThemeModePreviews
@Composable
private fun WrapChipSelectedEnabledPreview() {
    PreviewTheme {
        WrapChip(
            modifier = Modifier.wrapContentWidth(),
...
@ThemeModePreviews
@Composable
private fun WrapChipSelectedDisabledPreview() {
    PreviewTheme {
        WrapChip(
            modifier = Modifier.wrapContentWidth(),
            label = { Text(text = "Selected & Disabled") },
            leadingIcon = leadingIcon,
            trailingIcon = trailingIcon,
            selected = true,
            enabled = false
...
@ThemeModePreviews
@Composable
private fun WrapChipUnselectedDisabledPreview() {
    PreviewTheme {
        WrapChip(
            modifier = Modifier.wrapContentWidth(),
            label = { Text(text = "Unselected & Disabled") },
            leadingIcon = leadingIcon,
            trailingIcon = trailingIcon,
            selected = false,
            enabled = false
